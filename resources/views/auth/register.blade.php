            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col-xl-10">
                    <div class="card rounded-3 text-black">
                        <div class="row g-0">
                            <div class="col-lg-6">
                                <div class="card-body pl-1 pr-1 pt-0 pb-0 mx-md-4">

                                    <div class="text-center" style="margin-bottom: 0; padding-bottom: 0">
                                        <a href="{{ 'home' }}">
                                    ...
                                    <form action="/register" method="post">
                                        @csrf
                                        <p><strong>Registrarse</strong></p><br>
                                        ...
                                        <div class="form-outline mb-2">
                                            ...
                                            <input type="password" id="password confirmation" class="form-control" name="password_confirmation" placeholder="Confirmar Contraseña">

                                        </div>

                                        <div class="text-center pt-1 mb-2 pb-1">
                                            <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-2" type="submit">Register</button>&nbsp;
                                        </div>
